...
export const DEFAULT_USAGE_GUIDE: UsageGuideData = {
  steps: [
    {
      ...
      content: [
        '헬보올패스 웹페이지에서 회원님께 딱 맞는 상품과 전국 70여개 지점의 상세 정보를 충분히 확인합니다.',
    ...
    },
    {
      ...
      content: [
        ...
        '전국 70여개 지점 중 회원님이 구매한 등급과 그 하위 등급 지점에서 자유롭게 이용가능합니다.',
        '멤버십 연기 및 양도는 불가능합니다.',
  ...
  benefit: {
    title: '헬보올패스만의 특별 혜택',
    lines: [
      '골프, 필라테스 등 특정 종목 등록 시에도 헬스시설은 전국 70여개 지점에서 헬보올패스로 자유롭게 이용 가능합니다.',
