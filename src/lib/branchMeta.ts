...
export const BRANCH_META: Record<string, BranchMeta> = {
  ...
  "부천역점": { slug: "bucheonyeok", info: "low", facilities: ["헬스", "PT", "필라테스", "GX", "골프", "사우나", "안마의자"], region: "경기도" },
  ...
  "대전시청점": { slug: "daejeonsicheong", info: "normal", facilities: ["헬스", "PT", "필라테스"], region: "대전광역시" },
  ...
  "서면점": { slug: "seomyeon", info: "rich", facilities: ["헬스", "PT", "GX"], region: "부산광역시" },
  ...
  "평택역점": { slug: "pyeongtaekyeok", info: "rich", facilities: ["헬스", "PT", "필라테스", "안마의자"], region: "경기도" },
