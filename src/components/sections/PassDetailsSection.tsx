    ...
    <section id="pass-details" className="w-full py-12 md:py-24 lg:py-32 bg-secondary/50">
      <div className="container px-4 md:px-6 animate-in fade-in-0 slide-in-from-bottom-5 duration-1000 ease-in-out">
        <Reveal className="flex flex-col items-center justify-center space-y-3 text-center mb-12">
          ...
          <h2 className="text-4xl font-black tracking-tighter sm:text-5xl md:text-6xl text-foreground leading-[1.05]">
            내게 맞는 <span className="text-primary">헬보올패스</span><br className="hidden sm:block" /> 등급 찾기
          </h2>
            ...
            return (
              ...
              <Card className={`group relative h-full overflow-hidden bg-card text-card-foreground border-border/50 shadow-md text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-xl ${tier.glow}`}>
                ...
                <CardHeader>
                  ...
                  <CardTitle className={`text-2xl font-black tracking-tight ${tier.color}`}>{tier.name}</CardTitle>
                </CardHeader>
                <CardContent>
