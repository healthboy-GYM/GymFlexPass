    ...
    <section id="core-values" className="relative w-full py-12 md:py-24 lg:py-32 bg-secondary text-secondary-foreground overflow-hidden">
      ...
      <div className="container relative z-10 px-4 md:px-6 animate-in fade-in-0 slide-in-from-bottom-5 duration-1000 ease-in-out">
        <Reveal className="flex flex-col items-center justify-center space-y-3 text-center mb-12">
          ...
          <h2 className="text-4xl font-black tracking-tighter md:text-5xl lg:text-6xl text-foreground leading-[1.05]">
            당신의 운동을<br className="sm:hidden" /> <span className="text-primary">혁신</span>합니다.
          </h2>
            ...
            return (
              ...
              <Card className="group flex h-full flex-col bg-card/80 text-card-foreground border-border/50 shadow-lg backdrop-blur-sm transition-all duration-300 hover:-translate-y-1.5 hover:border-primary/40 hover:shadow-primary/10">
                <CardHeader className="flex flex-col items-center text-center p-6 md:p-8">
                  <div className="mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-primary text-primary-foreground shadow-lg shadow-primary/20 transition-all duration-300 group-hover:scale-110">
                    <Icon className="h-8 w-8" />
                  </div>
                  <CardTitle className="text-xl md:text-2xl font-bold leading-snug text-foreground">{value.title}</CardTitle>
                </CardHeader>
