...
const tierData = [
  ...
  },
  {
    ...
    availability: [
        ...
        { region: '경기', gyms: ['상현점', '죽전점', '영통판타지움점', '상록수역점', '고양행신점', '병점점', '안산중앙점', '배곧점', '일산주엽점'] },
        { region: '대전', gyms: ['둔산점', '탄방점', '대전터미널점', '목원대점', '월평점', 'NC대전유성점', '관저점'] },
        { region: '충남', gyms: ['쌍용점'] },
    ],
  ...
  },
  {
    ...
    availability: [
      { region: '서울', gyms: ['가양역점'] },
      { region: '경기', gyms: ['비전점', '철산점'] },
      { region: '대전', gyms: ['가오점'] },
      { region: '충북', gyms: ['복대점'] },
      { region: '부산', gyms: ['당리점', '하단점'] },
